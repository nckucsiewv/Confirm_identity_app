...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<CharSequence> departmentList = ArrayAdapter.createFromResource(MainActivity.this,
                R.array.department,
        ...
        spinner_dep.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(MainActivity.this, "你選的是" + spinner_dep.getSelectedItem(), Toast.LENGTH_SHORT).show();
                chosenDepartment = spinner_dep.getSelectedItem().toString();
                Toast.makeText(MainActivity.this, chosenDepartment, Toast.LENGTH_SHORT).show();
            }
            @Override
        ...
        ArrayAdapter<CharSequence> dateList = ArrayAdapter.createFromResource(MainActivity.this,
                R.array.date,
                android.R.layout.simple_spinner_dropdown_item);
        ...
        spinner_dat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(MainActivity.this, "你選的是" + parent.getSelectedItem(), Toast.LENGTH_SHORT).show();
                chosenDate = spinner_dat.getSelectedItem().toString();
                Toast.makeText(MainActivity.this, chosenDate, Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
